    ...
    return (
        <header className='p-4 flex justify-between' >
            ...
            <div className='flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-200'>
                <div>Anywhere</div>
                <div className='border-l border-gray-350'></div>
                <div>Any week</div>
                <div className='border-l border-gray-350'></div>
                <div>Add guest</div>
            ...
            <Link to={user? 'account' : '/login'} className='flex item-center gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-200'>
